...
The average score $\bar{R_{S}}$ of all the solutions is calculated. Every solution above the average score is considered as approved solution to be selected the deployment plan.
