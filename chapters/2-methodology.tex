...
Functions are first identified by thematic analysis. The functions are the categories for the questions to be identified in the qualitative analysis, since the existing transcripts of interviews already provide a clear separation of functions.
	% qualitative analysis

With all the functions inside the department defined, a qualitative analysis is progressed, trying to find all the issues that can be classified into a
